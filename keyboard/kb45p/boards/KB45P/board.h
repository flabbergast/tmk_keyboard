 ...
 */
#define BOARD_KB45P
#define BOARD_NAME                  "KB45P keyboard"
 ...
 * PB3  - PIN3                      (output pushpull).
 * PB4  - PIN4                      (output pushpull).
 * PB5  - PIN5                      (output pushpull).
 * PB6  - PIN6                      (output pushpull).
 * PB7  - LED                       (output pushpull).
 * PB8  - BUTTON                    (input floating).
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_BUTTON, 0) |         \
